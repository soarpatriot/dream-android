...
public class PullToRefreshListView extends ListView {
	...
	/**
	 * Avoid pull all the screen height will make header view too large, so make a
	 * scale ratio.
	 */
	...
	/**
	 * If you pull down but not release, your finger move up, this time we should
	...
	private void initView(Context context) {
		...
		mHeader = inflater.inflate(R.layout.main_pull_to_refresh_header, null);
...
//				else
	...
	private void changeState() {
			if (mState == State.ORIGNAL) {
				...
				iv_arrow.clearAnimation();
				tv_title.setText(getResources().getString(R.string.release_to_refresh));
	...
	public void onRefreshComplete() {
		...
		tv_time.setText(getResources().getString(R.string.update_time) + date);
	}
