 ...
 */
public class RefreshAddHandler extends Handler {
    ...
    public RefreshAddHandler(Context context, PullToRefreshListView pullToRefreshView, DreamListAdapter dreamAdapter){
